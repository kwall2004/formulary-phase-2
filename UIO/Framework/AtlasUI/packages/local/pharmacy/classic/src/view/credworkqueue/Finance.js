Ext.define('Atlas.pharmacy.view.credworkqueue.Finance', {
    extend: 'Ext.grid.Panel',
    xtype: 'credworkqueue-finance',
    reference: 'credworkqueue-finance',
    title: {
        bind: '{financeLbl}'
    },
        ...
        items: [{
            ...
            items: [{
                ...
                handler: function(grid, rowIndex) {
                    ...
                    vc.onAcknowledgeClick(grid, rowIndex, vm.data.finance);
                }
            }]
        }]
    },
        ...
        items: ['->',{
            ...
            handler: function(button) {
                var gridPanel = button.up('panel'),
                    ...
                    topPanel = accordionPanel.up('panel'),
                    vc = topPanel.controller;
                vc.onCredWorkQueueExportClick(gridPanel, 'Finance');
            }
        }]
    },  {
        xtype: 'pagingtoolbar',
