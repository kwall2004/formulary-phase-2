Ext.define('Atlas.pharmacy.model.MissingInfo', {
    ...
    //fields: ['CredLevel', 'NCPDPId', 'PharmName', 'RelationshipId', 'RelName', 'CredStDate', 'StaffName', 'CredType', 'CredStatus', 'credLogId']
});
