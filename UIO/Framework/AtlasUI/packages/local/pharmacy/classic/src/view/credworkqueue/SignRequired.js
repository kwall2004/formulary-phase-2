Ext.define('Atlas.pharmacy.view.credworkqueue.SignRequired', {
    extend: 'Ext.grid.Panel',
    xtype: 'credworkqueue-signrequired',
    reference: 'credworkqueue-signrequired',
    title: {
        bind: '{signRequiredLbl}'
    },
        ...
        items: [{
            ...
            items: [{
                ...
                handler: function(grid, rowIndex) {
                    ...
                    vc.onAcknowledgeClick(grid, rowIndex, vm.data.signRequired);
                }
            }]
        }]
    },
        ...
        items: ['->',{
            ...
            handler: function(button) {
                var gridPanel = button.up('panel'),
                    ...
                    topPanel = accordionPanel.up('panel'),
                    vc = topPanel.controller;
                vc.onCredWorkQueueExportClick(gridPanel, 'SignatureRequired');
            }
        }]
    },  {
        xtype: 'pagingtoolbar',
