Ext.define('Atlas.pharmacy.view.credworkqueue.InitialReceived', {
    extend: 'Ext.grid.Panel',
    xtype: 'credworkqueue-initialrecieved',
    reference: 'credworkqueue-initialrecieved',

    title: {
        bind: '{initialReceivedLbl}'
    },

    bind: '{initialReceived}',
        ...
        items: ['->',{
            ...
            handler: function(button, event) {
                var gridPanel = button.up('panel'),
                    ...
                    topPanel = accordionPanel.up('panel'),
                    vc = topPanel.controller;
                 vc.onCredWorkQueueExportClick(gridPanel, 'InitialReceived');
            }
        }]
    },{
        xtype: 'pagingtoolbar',
