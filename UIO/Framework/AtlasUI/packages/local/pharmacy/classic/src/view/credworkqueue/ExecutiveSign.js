Ext.define('Atlas.pharmacy.view.credworkqueue.ExecutiveSign', {
    extend: 'Ext.grid.Panel',
    xtype: 'credworkqueue-executivesign',
    reference: 'credworkqueue-executivesign',
    title: {
        bind: '{executiveSignLbl}'
    },
        ...
        items: [{
            ...
            items: [{
                ...
                handler: function(grid, rowIndex) {
                    ...
                    vc.onAcknowledgeClick(grid, rowIndex, vm.data.executiveSign);
                }
            }]
        }]
    },
        ...
        items: ['->',{
            ...
            handler: function(button) {
                var gridPanel = button.up('panel'),
                    ...
                    topPanel = accordionPanel.up('panel'),
                    vc = topPanel.controller;
                vc.onCredWorkQueueExportClick(gridPanel, 'ExecutiveSignature');
            }
        }]
    },  {
        xtype: 'pagingtoolbar',
