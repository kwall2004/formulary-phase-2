...
Ext.define('Atlas.authorization.model.cdag.OutreachEntityModelProviderAppeal', {
            ...
            rootProperty: function(payload) {
                if(payload.data.length > 0) {
                    payload.data.forEach(function (item, index) {
                        if (item.DeterminationType == 'CD' || item.DeterminationType == 'DMR' || (item.Description.indexOf('Member') > -1)) {
