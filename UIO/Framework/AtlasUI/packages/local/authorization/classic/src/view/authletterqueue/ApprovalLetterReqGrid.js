/*
    ...
    section of Approval Letter Reqs in the Authorization package.
    Orgin: Merlin
                  
*/

Ext.define('Atlas.authorization.view.authletterqueue.ApprovalLetterReqGrid', {
    xtype: 'authorization.ApprovalLetterReqGrid',
    itemId: 'gridApprovalLetterReq',
    controller: 'ApprovalLetterReqGridController',
    ...
    columns:[
        ...
        },
        {
            ...
            editor :
            {
                ...
                listeners:{select: 'assignToSelect'}
            }
        },
