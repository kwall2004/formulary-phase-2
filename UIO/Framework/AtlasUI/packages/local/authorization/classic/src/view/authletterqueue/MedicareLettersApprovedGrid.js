...
/*
    ...
    section of Medicare Letters Approved in the Authorization package.
    Orgin: Merlin
                  
*/

Ext.define('Atlas.authorization.view.authletterqueue.MedicareLettersApprovedGrid', {
    xtype: 'authorization.MedicareLettersApprovedGrid',
    itemId:'gridMedicareApprovedLetter',
    controller:'MedicareLettersApprovedGridController',
    ...
    bind:{
        store: '{MedicareApprovedLetterStore}'
    },
    columns:[
        {
            xtype: 'widgetcolumn',
