...
/*
    ...
    section of Medicare Letters Pending in the Authorization package.
    Orgin: Merlin
                  
*/
Ext.define('Atlas.authorization.view.authletterqueue.MedicareLettersPendingGrid', {
    xtype: 'authorization.MedicareLettersPendingGrid',
    itemId:'gridMedicarePendingLetter',
    controller:'MedicareLettersPendingGridController',
    ...
    bind:{
        store: '{MedicarePendingLetterStore}'
    },
    columns:[
        {
            xtype: 'widgetcolumn',
