...
Ext.define('Atlas.casemanagement.view.casemanagementqueue.MTMTMRGrid', {
    ...
    columns:[
        ...
        {text:'Days Remaining', dataIndex:'daysRemaining',hidden:true},
    ...
    dockedItems: [{
        dock:'bottom',
        xtype: 'pagingtoolbar',
        itemId: 'gridPagingToolbarMTMTMR',
        displayInfo: 'true',
        pageSize: 25,
        hideRefresh:true,
      /*  doRefresh: function () {
