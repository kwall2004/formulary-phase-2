...
Ext.define('Atlas.casemanagement.view.casemanagementqueue.MTMInvitationCallGrid', {
    xtype: 'Casemanagement.MTMInvitationCallGrid',
    extend: 'Ext.grid.Panel',
    requires: 'Atlas.common.VTypes',
    listeners: {
        expand: 'ShowQueues'
    },
    tbar: [
        ...
        {
            xtype: 'textfield',
            fieldLabel: '# of Call Attempts (>=)',
            maskRe: /[0-9]/,
            itemId: 'txtCallAttempts'
        },
        {
            xtype: 'button',
            text: 'Search',
            iconCls: 'x-fa fa-search',
            handler: 'ValidateInvitationQSearch'
        },
        {
            xtype: 'button',
            text: 'Reset',
            iconCls: 'x-fa fa-rotate-left',
            handler: 'resetInvitationQSearch'
        }
    ],
    columns: [
        {
        ...
        {text: '# of Call Attempts', dataIndex: 'callAttemptsCount'},
    ...
    dockedItems: [{
        dock: 'bottom',
        xtype: 'pagingtoolbar',
        itemId: 'gridPagingToolbarMTMInvitationCallQueue',
        displayInfo: 'true',
        hideRefresh:true,
        pageSize: 25,
        // doRefresh: function () {
