Ext.define('Atlas.atlasformulary.view.umprograms.RulesPanelController', {
  extend: 'Ext.app.ViewController',
  alias: 'controller.steptherapyconfig-rulespanelcontroller',
  rulesGrid: null,
  tiers: null,
  ...
  init: function () {
    this.getViewModel().set('whichpage', 'StepTherapyConfig');
    ...
    this.getView().down('#activateButton').setHidden(mode === 'review');

    this.rulesGrid = Ext.create('Atlas.atlasformulary.view.umprograms.RulesGrid', {
