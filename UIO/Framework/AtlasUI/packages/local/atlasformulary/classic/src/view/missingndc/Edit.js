Ext.define('Atlas.atlasformulary.view.missingndc.Edit', {
  extend: 'Ext.window.Window',
  xtype: 'missingndc-edit',

  controller: 'missingNdc_edit',

  title: 'Edit Missing NDC',
  ...
  initComponent: function () {
    this.callParent();
    this.getViewModel().set('missingNDC', this.missingNdc);
