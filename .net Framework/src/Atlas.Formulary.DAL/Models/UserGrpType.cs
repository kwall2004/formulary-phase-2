...
namespace Atlas.Formulary.DAL.Models
{
    ...
    public partial class UserGrpType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public UserGrpType()
        {
            this.UserGrp = new HashSet<UserGrp>();
        }
    
        public long UserGrpTypeSK { get; set; }
        public string UserGrpTypeCode { get; set; }
        public string UserGrpTypeDesc { get; set; }
        ...
        public virtual ICollection<UserGrp> UserGrp { get; set; }
    }
}
