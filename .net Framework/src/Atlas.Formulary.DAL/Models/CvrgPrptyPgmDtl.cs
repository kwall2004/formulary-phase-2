...
namespace Atlas.Formulary.DAL.Models
{
    ...
    public partial class CvrgPrptyPgmDtl
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public CvrgPrptyPgmDtl()
        {
            this.CvrgPrptyPgmDtlCrtriaGrp = new HashSet<CvrgPrptyPgmDtlCrtriaGrp>();
        }
    
        public long CvrgPrptyPgmDtlSK { get; set; }
        public Nullable<long> CvrgPrptyPgmSK { get; set; }
        public Nullable<int> StepNbr { get; set; }
        public Nullable<int> LookBackPerDays { get; set; }
        public Nullable<int> NbrFills { get; set; }
        public Nullable<int> TrialDaysMin { get; set; }
        ...
        public virtual CvrgPrptyPgm CvrgPrptyPgm { get; set; }
