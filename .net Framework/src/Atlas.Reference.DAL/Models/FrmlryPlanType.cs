...
namespace Atlas.Reference.DAL.Models
{
    ...
    public partial class FrmlryPlanType
    {
        public long FrmlryPlanTypeSK { get; set; }
        public string FrmlryPlanTypeCd { get; set; }
        public string FrmlryPlanTypeName { get; set; }
        public string FrmlryPlanTypeDesc { get; set; }
