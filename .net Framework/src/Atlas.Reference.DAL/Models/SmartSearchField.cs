...
namespace Atlas.Reference.DAL.Models
{
    ...
    public partial class SmartSearchField
    {
        public long SmartSearchFieldSK { get; set; }
        public string SmartSearchFieldName { get; set; }
        public Nullable<long> SmartSearchGroupSK { get; set; }
