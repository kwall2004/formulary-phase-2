...
namespace Atlas.Reference.DAL.Models
{
    ...
    public partial class FrmlryPlanSubType
    {
        public long FrmlryPlanSubTypeSK { get; set; }
        public string FrmlryPlanSubTypeCd { get; set; }
        public string FrmlryPlanSubTypeName { get; set; }
        public string FrmlryPlanSubTypeDesc { get; set; }
