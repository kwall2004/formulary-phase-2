...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class FreqQulfrType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public FreqQulfrType()
        {
            this.DeducblEpsd = new HashSet<DeducblEpsd>();
            this.DeducblEpsd1 = new HashSet<DeducblEpsd>();
            this.PymtPrflDtl = new HashSet<PymtPrflDtl>();
        }
    
        public int FreqQulfrTypeSK { get; set; }
        public string FreqQulfrCode { get; set; }
        public string FreqQulfrDesc { get; set; }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<PymtPrflDtl> PymtPrflDtl { get; set; }
    }
}
