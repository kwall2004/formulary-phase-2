...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class FrmlryTierName
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public FrmlryTierName()
        {
            this.FrmlryTier = new HashSet<FrmlryTier>();
        }
    
        public long FrmlryTierNameSK { get; set; }
        public long FrmlrySK { get; set; }
        public short SeqNbr { get; set; }
        public Nullable<int> FrmlryTierID { get; set; }
        public string FrmlryTierCode { get; set; }
        public string FrmlryTierName1 { get; set; }
