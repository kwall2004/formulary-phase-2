...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class PstlCode
    {
        ...
        public PstlCode()
        {
            ...
            this.SvcAreaPstlCode = new HashSet<SvcAreaPstlCode>();
        }
    
        public long PstlCodeSK { get; set; }
        public long ISOCntryCodeSK { get; set; }
        public string PstlCode1 { get; set; }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<SvcAreaPstlCode> SvcAreaPstlCode { get; set; }
    }
}
