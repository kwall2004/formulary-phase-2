...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class CopayOvrrdQulfrType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public CopayOvrrdQulfrType()
        {
            this.CopayOvrrd = new HashSet<CopayOvrrd>();
        }
    
        public long CopayOvrrdQulfrTypeSK { get; set; }
        public string CopayOvrrdQulfrTypeCode { get; set; }
        public string CopayOvrrdQulfrTypeDesc { get; set; }
