...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class FillExcpChngQulfrType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public FillExcpChngQulfrType()
        {
            this.FillExcp = new HashSet<FillExcp>();
        }
    
        public long FillExcpChngQulfrTypeSK { get; set; }
        public string FillExcpChngQulfrTypeCode { get; set; }
        public string FillExcpChngQulfrTypeDesc { get; set; }
