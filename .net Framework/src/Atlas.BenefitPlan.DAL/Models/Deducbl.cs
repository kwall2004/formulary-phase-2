...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class Deducbl
    {
        public long DeducblSK { get; set; }
        public long DeducblTypeSK { get; set; }
        public Nullable<long> DeducblScopeTypeSK { get; set; }
        ...
        public Nullable<long> LICSSetupSK { get; set; }
        ...
        public virtual DeducblScopeType DeducblScopeType { get; set; }
        public virtual DeducblType DeducblType { get; set; }
        public virtual LICSSetup LICSSetup { get; set; }
