...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class CMSBnftStructType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public CMSBnftStructType()
        {
            this.BnftPlan = new HashSet<BnftPlan>();
        }
    
        public long CMSBnftStructTypeSK { get; set; }
        public string CMSBnftStructTypeCode { get; set; }
        public string CMSBnftStructTypeDesc { get; set; }
