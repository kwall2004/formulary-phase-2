...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class PlanClsfcnType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public PlanClsfcnType()
        {
            this.BnftPlan = new HashSet<BnftPlan>();
        }
    
        public long PlanClsfcnTypeSK { get; set; }
        public string PlanClsfcnTypeCode { get; set; }
        public string PlanClsfcnTypeDesc { get; set; }
