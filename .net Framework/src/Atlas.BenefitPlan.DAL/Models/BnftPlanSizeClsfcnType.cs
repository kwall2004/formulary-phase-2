...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class BnftPlanSizeClsfcnType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public BnftPlanSizeClsfcnType()
        {
            this.BnftPlan = new HashSet<BnftPlan>();
        }
    
        public long BnftPlanSizeClsfcnTypeSK { get; set; }
        public string BnftPlanSizeClsfcnCode { get; set; }
        public string BnftPlanSIzeClsfcnDesc { get; set; }
