...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class CopayFuncType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public CopayFuncType()
        {
            this.BnftPlan = new HashSet<BnftPlan>();
        }
    
        public long CopayFuncTypeSK { get; set; }
        public string CopayFuncTypeCode { get; set; }
        public string CopayFuncTypeDesc { get; set; }
