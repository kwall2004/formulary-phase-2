...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class HealthcareFinclAcctType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public HealthcareFinclAcctType()
        {
            this.PopGrpPBPHealthcareFinclAcct = new HashSet<PopGrpPBPHealthcareFinclAcct>();
        }
    
        public long HealthcareFinclAcctTypeSK { get; set; }
        public string HealthcareFinclAcctTypeCode { get; set; }
        public string HealthcareFinclAcctTypeDesc { get; set; }
