...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class CrtriaSetType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public CrtriaSetType()
        {
            this.ValQulfrType = new HashSet<ValQulfrType>();
        }
    
        public long CrtriaSetTypeSK { get; set; }
        public string CrtriaSetTypeCode { get; set; }
        public string CrtriaSetTypeDesc { get; set; }
        ...
        public virtual ICollection<ValQulfrType> ValQulfrType { get; set; }
    }
}
