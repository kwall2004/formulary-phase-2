...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class ConfgPrptyCatgType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public ConfgPrptyCatgType()
        {
            this.ConfgPrptyType = new HashSet<ConfgPrptyType>();
        }
    
        public long ConfgPrptyCatgTypeSK { get; set; }
        public string ConfgPrptyCatgTypeCode { get; set; }
        public string ConfgPrptyCatgTypeDesc { get; set; }
        ...
        public virtual ICollection<ConfgPrptyType> ConfgPrptyType { get; set; }
    }
}
