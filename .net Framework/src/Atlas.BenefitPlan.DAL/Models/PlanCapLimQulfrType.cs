...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class PlanCapLimQulfrType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public PlanCapLimQulfrType()
        {
            this.PlanCapLim = new HashSet<PlanCapLim>();
        }
    
        public long PlanCapLimQulfrTypeSK { get; set; }
        public string PlanCapLimQulfrTypeCode { get; set; }
        public string PlanCapLimQulfrTypeDesc { get; set; }
