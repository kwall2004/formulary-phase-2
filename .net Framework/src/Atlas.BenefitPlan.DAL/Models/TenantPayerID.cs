...
namespace Atlas.BenefitPlan.DAL.Models
{
    ...
    public partial class TenantPayerID
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public TenantPayerID()
        {
            this.AcctPayerID = new HashSet<AcctPayerID>();
        }
    
        public long TenantPayerIDSK { get; set; }
        public long PayerIDSK { get; set; }
        ...
        public virtual PayerID PayerID { get; set; }
