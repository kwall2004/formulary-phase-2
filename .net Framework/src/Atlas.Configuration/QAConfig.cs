...
namespace Atlas.Configuration
{
    public class QAConfig : IConfig
    {
        ...
        public string FormularyConnectionString
        {
            get
            {
                return @"metadata=res://*/Models.Formulary.csdl|res://*/Models.Formulary.ssdl|res://*/Models.Formulary.msl;provider=System.Data.SqlClient;provider connection string='data source=MIRXSQL01-QVW\INST01Q;initial catalog=AtlasFormulary;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework'";
            }
        }
