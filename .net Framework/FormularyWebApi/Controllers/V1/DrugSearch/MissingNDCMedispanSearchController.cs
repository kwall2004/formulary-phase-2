...
namespace AtlasWebApi.Controllers.V1.DrugSearch
{
    ...
    /// </summary>
    public class MissingNDCMedispanSearchController : ApiController
    {
        ...
        public MissingNDCMedispanSearchController(IExceptionMessageGenerator exceptionResponseGenerator, IFormularyRepositoryFactory FormularyRepoFactory)
        {
        ...
        public IHttpActionResult Search(string queryString)
        {
            try
            {
                ...
                {
                    var queryResult = repo.MissingNDCMedispanSearch(queryString);
