...
namespace AtlasWebApi.Controllers.V1.DrugSearch
{
    ...
    /// </summary>
    public class MedispanDrugSearchController : ApiController
    {
        ...
        public MedispanDrugSearchController(IDrugSearchBLL bll, IExceptionMessageGenerator exceptionResponseGenerator, IFormularyRepositoryFactory FormularyRepoFactory)
        {
            _bll = bll;
        ...
        /// <returns></returns>
        [HttpPost]
        public IHttpActionResult MedispanDrugSearch(DrugSearchRequest<Criteria> query)
        {
            try
            {
                var result = _bll.SearchMedispan(query.Payload,
                                                 query.StartIndex,
                                                 query.Count,
                                                 query.FormularySK,
                                                 query.OrderBy,
