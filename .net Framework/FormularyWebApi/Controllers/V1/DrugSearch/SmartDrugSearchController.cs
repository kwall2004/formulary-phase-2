...
namespace AtlasWebApi.Controllers.V1.DrugSearch
{
    ...
    /// </summary>
    public class SmartDrugSearchController : ApiController
    {
        ...
        public SmartDrugSearchController(IDrugSearchBLL bll, IExceptionMessageGenerator exceptionResponseGenerator, IFormularyRepositoryFactory FormularyRepoFactory)
        {
            _bll = bll;
        ...
        /// <returns></returns>
        [HttpGet]
        public IHttpActionResult FdbSmartDrugSearch(string queryString, long? smartColumnSK = null)
        {
            try
            {
                QueryResult<SmartSearchResult> result = _bll.SmartSearch(queryString, smartColumnSK);
                return Ok(result);
