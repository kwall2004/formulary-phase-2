...
{
    public class DrugListConfigSmartDrugSearchController : ApiController
    {
        ...
        public DrugListConfigSmartDrugSearchController(IDrugSearchBLL bll, IExceptionMessageGenerator exceptionResponseGenerator, IFormularyRepositoryFactory FormularyRepoFactory)
        {
            _bll = bll;
        ...
        /// <returns></returns>
        [HttpGet]
        public IHttpActionResult DrugListSmartDrugSearch(string queryString, long drugListSK, long smartColumnSK)
        {
            try
            {
                QueryResult<SmartSearchResult> result = _bll.DrugListSmartSearch(queryString, drugListSK, smartColumnSK);
                return Ok(result);
        ...
        public IHttpActionResult DrugListSmartDrugSearch(string queryString, long drugListSK)
        {
            try
            {
                QueryResult<SmartSearchResult> result = _bll.DrugListSmartSearch(queryString, drugListSK, null);
                return Ok(result);
