...
namespace BenefitPlanCompare.Models
{
    public class Benefit : CompareEntity
    {
        ...
        public List<CompareResults> CompareCoveragePhase(Benefit another)
        {
            List<CompareResults> results = new List<CompareResults>();
        ...
        public List<CompareResults> CompareCopay(Benefit another)
        {
            List<CompareResults> results = new List<CompareResults>();
        ...
        public List<CompareResults> CompareCopayDistribution(Benefit another)
        {
            List<CompareResults> results = new List<CompareResults>();
        ...
        public List<CompareResults> CompareDAWCopay(Benefit another)
        {
            List<CompareResults> results = new List<CompareResults>();
        ...
        public List<CompareResults> ComparePharmaLimits(Benefit another)
        {
            List<CompareResults> results = new List<CompareResults>();
        ...
        public List<CompareResults> CompareProgramCode(Benefit another)
        {
            List<CompareResults> results = new List<CompareResults>();
