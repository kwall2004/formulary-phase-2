...
namespace Atlas.Formulary.DAL.Integration.Test.DrugSourceFileHistory
{
    [TestClass]
    public class DrugSourceFileHistoryIT
    {
        ...
        public void Create()
        {
            ...
            using (var Repo = _formFactory.DrugSourceFileHistory())
            {
