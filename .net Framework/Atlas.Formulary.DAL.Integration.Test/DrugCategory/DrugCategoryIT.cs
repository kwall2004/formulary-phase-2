...
namespace Atlas.Formulary.DAL.Integration.Test.DrugCategory
{

    [TestClass]
    public class DrugCategoryIT
    {
        ...
        public void Create()
        {
            ...
            using (var Repo = _formFactory.DrugCategory())
            {
                using (var fdbRepo = _refFactory.FDBDrugList())
                {
                    ...
                    var x=Repo.SetCoverageProperties(drugCoverage);
                    Assert.AreEqual(1, 1);
                }
            }
        }
        ...
        public void GetByID()
        {
            ...
            using (var fdbRepo = _refFactory.FDBDrugList())
            {
                ...
                Repo.GetAllDrugCategories(formularySK);
